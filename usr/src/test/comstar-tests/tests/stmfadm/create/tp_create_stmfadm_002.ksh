...
# 	Test: 
# 		Verify the creation success with host group name truncated 
# 		with 255 characters
...
function create002 {
	cti_pass
	tc_id="create002"
	tc_desc="Create host group with specified name which length is beyond 255"
	print_test_case $tc_id - $tc_desc

	typeset long_string=`random_string 300`

	stmfadm_create POS hg $long_string
