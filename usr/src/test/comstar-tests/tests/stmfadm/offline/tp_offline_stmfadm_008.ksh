...
# 
# DESCRIPTION:
# 	Verify that create-tg subcommand can be operated even stmf is offlined
# 
# STRATEGY:
# 
# 	Setup:
...
#		run "stmfadm create-tg " and verify its PASS
# 
# 	STRATEGY_NOTES:
# 
# KEYWORDS:
...
function offline008 {
	cti_pass
	tc_id="offline008"
	tc_desc="Verify stmfadm create-tg subcommand can be operated even stmf is offlined"
