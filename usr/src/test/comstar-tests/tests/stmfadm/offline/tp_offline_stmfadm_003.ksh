...
# 
# DESCRIPTION:
# 	Verify that remove-view subcommand can be operated even stmf is offlined
# 
# STRATEGY:
# 
# 	Setup:
...
#		Add the view with the specified LU
# 	Test: 
#		Disable stmf smf service by svcadm
#		run "stmfadm remove-view" and verify its PASS
# 	Cleanup:
...
function offline003 {
	cti_pass
	tc_id="offline003"
	tc_desc="Verify remove-view subcommand can be operated even stmf is offlined"
