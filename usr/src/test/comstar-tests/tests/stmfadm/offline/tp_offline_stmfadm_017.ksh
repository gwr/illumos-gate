...
# 
# DESCRIPTION:
# 	Verify that list-state subcommand can be operated even stmf is offlined
# 
# STRATEGY:
# 
# 	Setup:
...
#		run "stmfadm list-state" and verify its PASS
# 
# 	STRATEGY_NOTES:
# 
# KEYWORDS:
...
function offline017 {
	cti_pass
	tc_id="offline017"
	tc_desc="Verify list-state subcommand can be operated even stmf is offlined"
