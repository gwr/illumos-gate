...
# 
# DESCRIPTION:
# 	Verify that create-hg subcommand can be operated even stmf is offlined
# 
# STRATEGY:
# 
# 	Setup:
...
#		run "stmfadm create-hg " and verify its PASS
# 
# 	STRATEGY_NOTES:
# 
# KEYWORDS:
...
function offline007 {
	cti_pass
	tc_id="offline007"
	tc_desc="Verify stmfadm create-hg subcommand can be operated even stmf is offlined"
