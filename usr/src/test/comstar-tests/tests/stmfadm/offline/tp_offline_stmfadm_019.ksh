...
# 
# DESCRIPTION:
# 	Verify that offline-lu can be operated even stmf is offlined
# 
# STRATEGY:
# 
# 	Setup:
...
#		run "stmfadm offline-lu" and verify its PASS
# 	Cleanup:
...
function offline019 {
	cti_pass
	tc_id="offline019"
	tc_desc="Verify offline-lu subcommand can be operated even stmf is offlined"
