...
# 
# DESCRIPTION:
# 	Verify that delete-hg subcommand can be operated even stmf is offlined
# 
# STRATEGY:
# 
# 	Setup:
...
#		run "stmfadm delete-hg " and verify its PASS
# 
# 	STRATEGY_NOTES:
# 
# KEYWORDS:
...
function offline002 {
	cti_pass
	tc_id="offline002"
	tc_desc="Verify delete-hg subcommand can be operated even stmf is offlined"
