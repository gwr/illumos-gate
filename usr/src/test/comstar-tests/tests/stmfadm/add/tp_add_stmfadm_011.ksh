...
# 
# DESCRIPTION:
# 	Add a view without specified the -t option to 
# 	verify default target group is All
# 
# STRATEGY:
# 
# 	Setup:
...
# 		Add the view with hg and lu
# 	Test: 
# 		Verify the view addition success and target group is All
...
function add011 {
	cti_pass
	tc_id="add011"
	tc_desc="Add a view without specified the -t option to"
	tc_desc="$tc_desc verify default target group is All"
