...
# 
# DESCRIPTION:
# 	Attempt to add the conflict view with specified host group to logical
# 	unit which has the all host group existing view entry already
# 
# STRATEGY:
# 
# 	Setup:
...
# 		Add another view with tg1 and lun=0
# 	Test: 
...
function add016 {
	cti_pass
	tc_id="add016"
	tc_desc="Attempt to add the conflict view entry with specified "
	tc_desc="$tc_desc host group despite of the all host group"
	...
	stmfadm_add NEG view             -t ${TG[0]} -n 0 $guid
