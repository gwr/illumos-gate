...
# 
# DESCRIPTION:
# 	Add an offline target group member to a target group when stmf is disabled
# 
# STRATEGY:
# 
# 	Setup:
...
function add026 {
	cti_pass
	tc_id="add026"
	tc_desc="Verify the offline target can be added into target group with stmf disabled"
