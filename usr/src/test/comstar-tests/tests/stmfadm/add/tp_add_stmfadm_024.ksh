...
# 
# DESCRIPTION:
# 	Add an online target group member to a target group when stmf is enabled
# 
# STRATEGY:
# 
# 	Setup:
...
function add024 {
	cti_pass
	tc_id="add024"
	tc_desc="Verify the online target can be added into target group with stmf enabled"
