...
# 
# DESCRIPTION:
# 	Attempt to add a duplicated host group member to a host group 
...
# 		Add the duplicated fibre channel initiator port wwn into host group
# 		Add the duplicated iSCSI initiator node name into host group
# 	Test: 
...
function add003 {
	cti_pass
	tc_id="add003"
	tc_desc="Attempt to add a duplicated host group member to a host group"
	tc_desc="$tc_desc which is existed already"
	...
	stmfadm_add NEG hg-member -g ${HG[0]} eui.200000e08b909220
