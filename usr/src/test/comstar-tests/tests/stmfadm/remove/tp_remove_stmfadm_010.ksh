...
# 
# DESCRIPTION:
# 	Remove an offline target group member from a target group 
#	when stmf is disabled 
# 
# STRATEGY:
# 
# 	Setup:
...
function remove010 {
	cti_pass
	tc_id="remove010"
	tc_desc="Verify that remove an offline target from target group with stmf disabled"
