...
# 
# DESCRIPTION:
# 	Attempt to delete the All target group 
# 
# STRATEGY:
# 
# 	Setup:
...
# 		Add a view with the association of tg and lun
# 		Attempt to delete the All target group 
# 	Test: 
...
function delete007 {
	cti_pass
	tc_id="delete007"
	tc_desc="Attempt to delete the All target group" 
