...
# 
# DESCRIPTION:
# 	Create a duplicated logical unit that already exists and confirm
...
# 	Test: 
# 		Create the duplicated logical unit with the same filename
# 		Verify the failure
# 	Cleanup:
...
function create002 {
	cti_pass
	tc_id="create002"
	tc_desc="Attempt to create a logical unit that already exists and confirm"
