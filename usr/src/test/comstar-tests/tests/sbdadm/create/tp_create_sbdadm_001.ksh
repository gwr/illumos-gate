...
# 	with ufs file system that can be registered with stmf
# 
# STRATEGY:
# 
# 	Setup:
# 		Build ufs filesystem for device
# 		Create the logical unit with ufs file
# 	Test: 
# 		Verify the logical unit size
...
function create001 {
	...
	tc_desc="$tc_desc k m g t with ufs file system"
