...
# 
# DESCRIPTION:
# 	Modify the attribute size to the new size of the existing GUID or LU Path
# 
# STRATEGY:
# 
# 	Setup:
# 		Create a logical unit
# 		Modify the size attribute by GUID
# 		Modify the size attribute by LU Path
# 	Test: 
...
function modify003 {
	...
	tc_desc="$tc_desc of the existing GUID or LU Path"
	...
	sbdadm_modify_lu POS -s 2g $guid
