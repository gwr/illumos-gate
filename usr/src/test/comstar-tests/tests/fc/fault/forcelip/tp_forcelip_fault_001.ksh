...
# 
# DESCRIPTION:
# 	Luxadm -e forcelips on the host side without I/O 
# 
# STRATEGY:
# 
# 	Setup:
...
# 		Test duration will be preferred with 24 hours.
# 	Test: 
# 		Host side cable pull gap is 5 minutes,
# 		Issue luxadm -e forcelip from hostside without any I/O,
# 		target port should show up in the mpathadm output 
# 		on the host side,
# 		initiator should show up in the stmfadm list-target -v output 
# 		on the target side.
# 	Cleanup:
# 
# 	STRATEGY_NOTES:
...
# 
# __stc_assertion_end
function forcelip001 {
	cti_pass
	tc_id="forcelip001"
	tc_desc="Luxadm -e forcelips on the host side without I/O"
	...
	cleanup_mapping
	[[ $ret -eq 0 ]] && cti_pass "tp_iscsi_fs_002: PASS"
}
