...
# 
# DESCRIPTION:
# 	Target cable pullss with I/O and data validation by stmfadm offline/online target
# 
# STRATEGY:
# 
# 	Setup:
...
# 
# __stc_assertion_end
function tgtcablepull002 {
	cti_pass
	tc_id="tgtcablepull002"
	tc_desc="Target cable pullss with I/O and data validation"
	tc_desc="$tc_desc by stmfadm offline/online target"
	...
	fc_target_online_offline_io $FC_IHOST $TS_SNOOZE $TS_MAX_ITER
	...
	cleanup_mapping
	[[ $ret -eq 0 ]] && cti_pass "tp_tgtcablepull_fault_002: PASS"
