...
# 
# DESCRIPTION:
# 	Offline stmf service on the target side without I/O
# 
# STRATEGY:
# 
# 	Setup:
...
# 
# __stc_assertion_end
function stmfoffline001 {
	cti_pass
	tc_id="stmfoffline001"
	tc_desc="Offline stmf service on the target side without I/O"
