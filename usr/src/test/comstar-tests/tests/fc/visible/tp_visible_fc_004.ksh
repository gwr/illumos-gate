...
# 
# DESCRIPTION:
# 	Verify the view visibility with stmf service offline
# 
# STRATEGY:
# 
# 	Setup:
...
# 		svcadm disable stmf service
# 	Test: 
# 		Verify the host side can not see any target device
# 	Cleanup:
...
function visible004 {
	cti_pass
	tc_id="visible004"
	tc_desc="Verify the view visibility with stmf service offline"
