...
#
# ID: itadm_create_target_p_syntax_001
#
# DESCRIPTION:
# 	itadm create-target command successfully creates the specified
# 	target with all valid combinations of options
#
# STRATEGY:
...
#CMD="itadm_create POS target ^SET_1 ^SET_2 ^SET_3 ^SET_4 ^SET_5 " 
CMD="itadm_create POS target ^SET_0" 
...
STR_223=" \
iqn.1986-03.sun.com:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\
...
function itadm_create_target_p_syntax
{
	cti_pass
	typeset -i i
	(( i = ${TET_TPNUMBER} - 1 ))	

        tc_id="itadm_create_target_p_syntax_${TET_TPNUMBER}"
	tc_desc="itadm create-target command successfully create target with { "
...
auto_generate_tp "CMD" "CMD_ARR" "itadm_create_target_p_syntax"
