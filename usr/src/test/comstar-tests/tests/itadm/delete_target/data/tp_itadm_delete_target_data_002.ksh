...
#
# ID: itadm_delete_target_data_002
#
# DESCRIPTION:
#	itadm delete-target fail to delete a online target
#
# STRATEGY:
#
#	Setup:
...
#		   message
#
#		3. itadm list target shows that <tgt1> were not impacted.
#
#	Cleanup:
...
# __stc_assertion_end
#
function tp_itadm_delete_target_data_002
{
	cti_pass

	typeset tc_id tc_desc 
        tc_id="tp_itadm_delete_target_data_002"
	tc_desc="itadm delete-target fail to delete a online target"

	print_test_case "${tc_id} - ${tc_desc}"

	itadm_create POS target -n "${IQN_TARGET}.${TARGET[0]}"

	itadm_delete NEG target "${IQN_TARGET}.${TARGET[0]}" 
