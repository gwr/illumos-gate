...
#
# DESCRIPTION:
#	Running I/O data validation on one initiator to multi targets
#
# STRATEGY:
#	Setup:
...
#		Create multi target nodes (specified by TARGET_MAX variable 
#		    in configuration) with tpgt 1
...
# __stc_assertion_end
#
function iscsi_fs_006
{
	cti_pass

        tc_id="iscsi_fs_006"
	tc_desc="verify I/O data validation on one initiator to multi targets"
	...
	[[ $ret -eq 0 ]] && cti_pass "tp_iscsi_fs_006: PASS"
}
