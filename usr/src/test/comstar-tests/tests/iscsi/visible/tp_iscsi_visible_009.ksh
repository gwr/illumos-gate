...
#
# ID: iscsi_visible_009
#
# DESCRIPTION:
#	initiator can get lun information through the target when
#	--datadigest option of initiator node is set to CRC32 
#
# STRATEGY:
#	Setup:
...
#
#	Test:
#		1. Set --datadigest option of initiator node to CRC32.
#
...
# __stc_assertion_end
#
function tp_iscsi_visible_009
{
	cti_pass

        tc_id="tp_iscsi_visible_009"

	tc_desc="initiator can get lun information through the target when"
	tc_desc="${tc_desc} --datadigest option of initiator node is set to"
