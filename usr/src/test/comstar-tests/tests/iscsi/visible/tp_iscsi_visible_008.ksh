...
#
# ID: iscsi_visible_008
#
# DESCRIPTION:
#	initiator can get lun information through the target when
#	--headerdigest option of initiator node is set to CRC32 
#
# STRATEGY:
#	Setup:
...
# __stc_assertion_end
#
function tp_iscsi_visible_008
{
	cti_pass

        tc_id="tp_iscsi_visible_008"

	tc_desc="initiator can get lun information through the target when"
	tc_desc="${tc_desc} --headerdigest option of initiator node is set to"
