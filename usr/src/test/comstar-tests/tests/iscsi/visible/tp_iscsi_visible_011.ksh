...
#
# ID: iscsi_visible_011
#
# DESCRIPTION:
#	initiator can get lun information through the target when
#	--datadigest option of target-param is set to CRC32 for
#	a target
#
# STRATEGY:
#	Setup:
...
#		
#	Test:
#		1. Set --datadigest option of targer-param to CRC32 for one 
#		   target.
#
...
# __stc_assertion_end
#
function tp_iscsi_visible_011
{
	cti_pass

        tc_id="tp_iscsi_visible_011"

	tc_desc="initiator can get lun information through the target when"
	tc_desc="${tc_desc} --datadigest option of target-param is set to"
