...
#
# ID: iscsi_visible_013
#
# DESCRIPTION:
#	initiator can get lun information through the target when
#	--headerdigest and --datadigest option of target-param
#	are set to CRC32 for the target
#
# STRATEGY:
#	Setup:
...
#
#	Test:
#		1. Set --headerdigest option of target-param to CRC32 for one
#		   target.
#
#		2. Set --datadigest option of target-param to CRC32 for one
#		   target.
#
