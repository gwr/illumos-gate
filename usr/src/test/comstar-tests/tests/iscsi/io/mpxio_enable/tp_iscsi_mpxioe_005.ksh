...
# 	by switch offline/online port when mpxio is enabled
# 
# STRATEGY:
# 
# 	Setup:
...
#
# __stc_assertion_end
function iscsi_mpxioe_005
{
	cti_pass
	tc_id="iscsi_mpxioe_005"
	tc_desc="I/O data validation with mpxio enabled by online/offline"
	...
	iscsiadm_modify POS $ISCSI_IHOST discovery -t enable
        ...
        switch_cable_pull_io $ISCSI_THOST $FO_SNOOZE $FO_MAX_ITER
