...
# __stc_assertion_end
#
function iscsi_mpxioe_004
{
	cti_pass
	tc_id="iscsi_mpxioe_004"
	tc_desc="I/O data validation with mpxio enabled by delete/create"
	...
	iscsi_target_port_delete_create_io $ISCSI_THOST $FO_SNOOZE $FO_MAX_ITER
