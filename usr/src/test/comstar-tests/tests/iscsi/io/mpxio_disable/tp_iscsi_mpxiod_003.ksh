...
#		    target host by ifconfig plub/unplumb option
...
# __stc_assertion_end
#
function iscsi_mpxiod_003
{
	cti_pass
	tc_id="iscsi_mpxiod_003"
	...
	iscsi_target_portal_up_down_io $ISCSI_THOST $TS_SNOOZE $TS_MAX_ITER
