...
#	with I/O data invalidation when mpxio is disabled
#
# STRATEGY:
#	Setup:
...
# __stc_assertion_end
#
function iscsi_mpxiod_001
{
	cti_pass
	tc_id="iscsi_mpxiod_001"
	tc_desc="I/O data validation with mpxio disabled by plumb/un-plumb"
	...
	iscsi_initiator_portal_up_down_io $ISCSI_IHOST $TS_SNOOZE $TS_MAX_ITER
