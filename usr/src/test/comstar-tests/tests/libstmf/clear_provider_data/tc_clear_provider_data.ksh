...
#
iclist="ic1 ic2 ic3"
ic1="stmfClearProviderData001"
ic2="stmfClearProviderData002"
ic3="stmfClearProviderData003"
...
function stmfClearProviderData001 {
	./tp_clear_pdata_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfClearProviderData002 {
	./tp_clear_pdata_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfClearProviderData003 {
	./tp_clear_pdata_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
