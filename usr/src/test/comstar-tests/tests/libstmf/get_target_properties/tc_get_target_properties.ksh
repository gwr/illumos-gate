...
ic1="stmfGetTargetProperties001"
ic2="stmfGetTargetProperties002"
ic3="stmfGetTargetProperties003"
ic4="stmfGetTargetProperties004"
...
function stmfGetTargetProperties001 {
	./tp_get_target_properties_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetTargetProperties002 {
	./tp_get_target_properties_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetTargetProperties003 {
	./tp_get_target_properties_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetTargetProperties004 {
	./tp_get_target_properties_004
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
