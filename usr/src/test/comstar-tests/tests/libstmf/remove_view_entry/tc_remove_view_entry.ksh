...
ic1="stmfRemoveViewEntry001"
ic2="stmfRemoveViewEntry002"
ic3="stmfRemoveViewEntry003"
ic4="stmfRemoveViewEntry004"
...
function stmfRemoveViewEntry001 {
	./tp_remove_view_entry_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfRemoveViewEntry002 {
	./tp_remove_view_entry_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfRemoveViewEntry003 {
	./tp_remove_view_entry_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfRemoveViewEntry004 {
	./tp_remove_view_entry_004
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
