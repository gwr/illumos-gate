...
#
iclist="ic1 ic2 ic3"
ic1="stmfGetTargetGroupList001"
ic2="stmfGetTargetGroupList002"
ic3="stmfGetTargetGroupList003"
...
function stmfGetTargetGroupList001 {
	./tp_get_target_group_list_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetTargetGroupList002 {
	./tp_get_target_group_list_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetTargetGroupList003 {
	./tp_get_target_group_list_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
