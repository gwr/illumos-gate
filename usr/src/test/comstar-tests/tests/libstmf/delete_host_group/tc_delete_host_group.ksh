...
#
iclist="ic1 ic2 ic3"
ic1="stmfDeleteHostGroup001"
ic2="stmfDeleteHostGroup002"
ic3="stmfDeleteHostGroup003"
...
function stmfDeleteHostGroup001 {
	./tp_delete_hg_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfDeleteHostGroup002 {
	./tp_delete_hg_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfDeleteHostGroup003 {
	./tp_delete_hg_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
