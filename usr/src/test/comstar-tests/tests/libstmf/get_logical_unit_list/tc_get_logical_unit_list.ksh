...
#
iclist="ic1 ic2 ic3"
ic1="stmfGetLogicalUnitList001"
ic2="stmfGetLogicalUnitList002"
ic3="stmfGetLogicalUnitList003"
...
function stmfGetLogicalUnitList001 {
	./tp_get_lu_list_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfGetLogicalUnitList002 {
	./tp_get_lu_list_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfGetLogicalUnitList003 {
	./tp_get_lu_list_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
