...
ic1="stmfDevidFromIscsiName001"
ic2="stmfDevidFromIscsiName002"
ic3="stmfDevidFromIscsiName003"
ic4="stmfDevidFromIscsiName004"
...
function stmfDevidFromIscsiName001 {
	./tp_devid_from_in_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfDevidFromIscsiName002 {
	./tp_devid_from_in_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfDevidFromIscsiName003 {
	./tp_devid_from_in_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfDevidFromIscsiName004 {
	./tp_devid_from_in_004
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
