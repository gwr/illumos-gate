...
#
iclist="ic1 ic2 ic3"
ic1="stmfGetHostGroupList001"
ic2="stmfGetHostGroupList002"
ic3="stmfGetHostGroupList003"
...
function stmfGetHostGroupList001 {
	./tp_get_host_group_list_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetHostGroupList002 {
	./tp_get_host_group_list_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetHostGroupList003 {
	./tp_get_host_group_list_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
