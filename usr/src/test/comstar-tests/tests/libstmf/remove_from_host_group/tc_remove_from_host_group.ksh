...
ic1="stmfRemoveFromHostGroup001"
ic2="stmfRemoveFromHostGroup002"
ic3="stmfRemoveFromHostGroup003"
ic4="stmfRemoveFromHostGroup004"
...
function stmfRemoveFromHostGroup001 {
	./tp_remove_from_hg_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfRemoveFromHostGroup002 {
	./tp_remove_from_hg_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfRemoveFromHostGroup003 {
	./tp_remove_from_hg_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfRemoveFromHostGroup004 {
	./tp_remove_from_hg_004
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
