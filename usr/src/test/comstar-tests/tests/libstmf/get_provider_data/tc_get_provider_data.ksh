...
ic1="stmfGetProviderData001"
ic2="stmfGetProviderData002"
ic3="stmfGetProviderData003"
ic4="stmfGetProviderData004"
ic5="stmfGetProviderData005"
...
function stmfGetProviderData001 {
	./tp_get_provider_data_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetProviderData002 {
	./tp_get_provider_data_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetProviderData003 {
	./tp_get_provider_data_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetProviderData004 {
	./tp_get_provider_data_004
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetProviderData005 {
	./tp_get_provider_data_005
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
