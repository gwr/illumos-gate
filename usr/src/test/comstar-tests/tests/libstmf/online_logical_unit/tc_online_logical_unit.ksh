...
#
iclist="ic1 ic2"
ic1="stmfOnlineLogicalUnit001"
ic2="stmfOnlineLogicalUnit002"
...
function stmfOnlineLogicalUnit001 {
	./tp_online_logical_unit_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfOnlineLogicalUnit002 {
	./tp_online_logical_unit_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
