...
#
iclist="ic1 ic2 ic3"
ic1="stmfCreateTargetGroup001"
ic2="stmfCreateTargetGroup002"
ic3="stmfCreateTargetGroup003"
...
function stmfCreateTargetGroup001 {
	./tp_create_tg_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfCreateTargetGroup002 {
	./tp_create_tg_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfCreateTargetGroup003 {
	./tp_create_tg_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
