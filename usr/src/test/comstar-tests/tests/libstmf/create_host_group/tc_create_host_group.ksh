...
#
iclist="ic1 ic2 ic3"
ic1="stmfCreateHostGroup001"
ic2="stmfCreateHostGroup002"
ic3="stmfCreateHostGroup003"
...
function stmfCreateHostGroup001 {
	./tp_create_hg_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfCreateHostGroup002 {
	./tp_create_hg_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfCreateHostGroup003 {
	./tp_create_hg_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
