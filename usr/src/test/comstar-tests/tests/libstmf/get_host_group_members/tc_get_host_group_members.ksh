...
ic1="stmfGetHostGroupMembers001"
ic2="stmfGetHostGroupMembers002"
ic3="stmfGetHostGroupMembers003"
ic4="stmfGetHostGroupMembers004"
...
function stmfGetHostGroupMembers001 {
	./tp_get_hg_members_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetHostGroupMembers002 {
	./tp_get_hg_members_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetHostGroupMembers003 {
	./tp_get_hg_members_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetHostGroupMembers004 {
	./tp_get_hg_members_004
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
