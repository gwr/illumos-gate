...
#
iclist="ic1 ic2 ic3"
ic1="stmfDeleteTargetGroup001"
ic2="stmfDeleteTargetGroup002"
ic3="stmfDeleteTargetGroup003"
...
function stmfDeleteTargetGroup001 {
	./tp_delete_tg_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfDeleteTargetGroup002 {
	./tp_delete_tg_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfDeleteTargetGroup003 {
	./tp_delete_tg_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
