...
ic1="stmfAddViewEntry001"
ic2="stmfAddViewEntry002"
ic3="stmfAddViewEntry003"
ic4="stmfAddViewEntry004"
...
function stmfAddViewEntry001 {
	./tp_add_view_entry_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfAddViewEntry002 {
	./tp_add_view_entry_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfAddViewEntry003 {
	./tp_add_view_entry_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfAddViewEntry004 {
	./tp_add_view_entry_004
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
