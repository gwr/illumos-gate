...
#
iclist="ic1 ic2"
ic1="stmfOfflineLogicalUnit001"
ic2="stmfOfflineLogicalUnit002"
...
function stmfOfflineLogicalUnit001 {
	./tp_offline_logical_unit_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfOfflineLogicalUnit002 {
	./tp_offline_logical_unit_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
