...
ic1="stmfGetViewEntryList001"
ic2="stmfGetViewEntryList002"
ic3="stmfGetViewEntryList003"
ic4="stmfGetViewEntryList004"
...
function stmfGetViewEntryList001 {
	./tp_get_view_entry_list_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetViewEntryList002 {
	./tp_get_view_entry_list_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetViewEntryList003 {
	./tp_get_view_entry_list_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetViewEntryList004 {
	./tp_get_view_entry_list_004
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
