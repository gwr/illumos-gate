...
ic1="stmfAddToTargetGroup001"
ic2="stmfAddToTargetGroup002"
ic3="stmfAddToTargetGroup003"
ic4="stmfAddToTargetGroup004"
...
function stmfAddToTargetGroup001 {
	./tp_add_to_target_group_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfAddToTargetGroup002 {
	./tp_add_to_target_group_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfAddToTargetGroup003 {
	./tp_add_to_target_group_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfAddToTargetGroup004 {
	./tp_add_to_target_group_004
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
