...
ic1="stmfSetProviderData001"
ic2="stmfSetProviderData002"
ic3="stmfSetProviderData003"
ic4="stmfSetProviderData004"
ic5="stmfSetProviderData005"
...
function stmfSetProviderData001 {
	./tp_set_pdata_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfSetProviderData002 {
	./tp_set_pdata_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfSetProviderData003 {
	./tp_set_pdata_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfSetProviderData004 {
	./tp_set_pdata_004
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
...
function stmfSetProviderData005 {
	./tp_set_pdata_005
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
