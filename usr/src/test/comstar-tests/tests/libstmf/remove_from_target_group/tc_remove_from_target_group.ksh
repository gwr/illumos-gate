...
ic1="stmfRemoveFromTargetGroup001"
ic2="stmfRemoveFromTargetGroup002"
ic3="stmfRemoveFromTargetGroup003"
ic4="stmfRemoveFromTargetGroup004"
...
function stmfRemoveFromTargetGroup001 {
	./tp_remove_from_tg_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfRemoveFromTargetGroup002 {
	./tp_remove_from_tg_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfRemoveFromTargetGroup003 {
	./tp_remove_from_tg_003
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfRemoveFromTargetGroup004 {
	./tp_remove_from_tg_004
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
