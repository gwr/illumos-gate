...
#
iclist="ic1 ic2"
ic1="stmfGetTargetList001"
ic2="stmfGetTargetList002"
...
function stmfGetTargetList001 {
	./tp_get_target_list_001
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
...
function stmfGetTargetList002 {
	./tp_get_target_list_002
	if [ $? -ne 0 ]; then
		cti_result FAIL
	else
		cti_result PASS
