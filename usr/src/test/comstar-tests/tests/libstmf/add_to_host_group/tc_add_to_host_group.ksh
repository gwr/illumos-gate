...
ic1="stmfAddToHostGroup001"
ic2="stmfAddToHostGroup002"
ic3="stmfAddToHostGroup003"
ic4="stmfAddToHostGroup004"

#
# Following functions invoke the binary test purpose
# and used by tet 
#
function stmfAddToHostGroup001 {
	./tp_add_to_host_group_001
	if [ $? -ne 0 ]; then
		cti_result "FAIL"
	else
		cti_result "PASS"
...
function stmfAddToHostGroup002 {
	./tp_add_to_host_group_002
	if [ $? -ne 0 ]; then
		cti_result "FAIL"
	else
		cti_result "PASS"
...
function stmfAddToHostGroup003 {
	./tp_add_to_host_group_003
	if [ $? -ne 0 ]; then
		cti_result "FAIL"
	else
		cti_result "PASS"
...
function stmfAddToHostGroup004 {
	./tp_add_to_host_group_004
	if [ $? -ne 0 ]; then
		cti_result "FAIL"
	else
		cti_result "PASS"
