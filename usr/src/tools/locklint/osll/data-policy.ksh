...
run_session()
{
	...
	run_command help-declare "$LOCK_LINT" help declare
	run_command help-funcs "$LOCK_LINT" help funcs
	run_command declare-root "$LOCK_LINT" declare root \
	    data-policy.c:check_data_policy || exit $?
...
SOURCE="$REPO_ROOT/usr/src/tools/locklint/tests/data-policy.c"
...
OSLL_RESULT_DIR="$RESULTS_ROOT/data-policy-$timestamp-$$"
...
OSLL_LL_FILE="$build_dir/data-policy.ll"
