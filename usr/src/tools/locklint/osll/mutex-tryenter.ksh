...
#
# Run focused mutex_tryenter result-sensitive cases under Solaris LockLint.
#
...
SOURCE="$REPO_ROOT/usr/src/tools/locklint/tests/mutex-tryenter.c"
...
OSLL_LL_FILE="$build_dir/mutex-tryenter.ll"
...
case "$analyze_status" in
0)
	print "OSLL mutex-tryenter analysis completed without findings."
	;;
5)
	print "OSLL mutex-tryenter analysis completed with findings."
	;;
*)
	print "OSLL mutex-tryenter analysis returned status $analyze_status."
	;;
esac
