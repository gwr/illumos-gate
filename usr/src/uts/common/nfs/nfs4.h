 ...
 */
boolean_t nfs_audit_init(struct svc_req *req, cred_t *cr, char **path,
    vnode_t *vp);
...
boolean_t nfs_audit_rename_init(struct svc_req *req, cred_t *cr, char **src,
    vnode_t *vp, char **dst, vnode_t *tvp, char **dpath, vnode_t *dvp);
