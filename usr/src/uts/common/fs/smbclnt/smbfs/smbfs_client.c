...
static void smbfattr_to_xvattr(vnode_t *, smbfattr_t *, vattr_t *);
 ...
 */
static void
smbfattr_to_xvattr(vnode_t *vp, struct smbfattr *fa, struct vattr *vap)
{
	/* struct smbnode *np = VTOSMB(vp);	XXX */
