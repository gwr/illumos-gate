 ...
 * The REG_* defines here are indices in the 64-bit register arrays.
 *
 ...
 * The REG32_* defines here are indices in the 32-bit register arrays.
...
/*
 * Some old code uses the names shown in the I386PSABI document:
 *
 *	"System V Application Binary Interface --
 *	Intel386 Architecture Processor Supplement (4th Edition)"
 *	Published by SCO (Santa Cruz Operation), 1997.
 *
 * https://www.sco.com/developers/devspecs/abi386-4.pdf
 *
 * Some of these names (CS, GS, EIP, ...) cause problems if exposed to
 * modern applications so they are defined only when the application is
 * compiled with: -D_REGSET_I386PSABI_NAMES
 */
#if defined(_ASM) || defined(_REGSET_I386PSABI_NAMES)
...
#endif	/* _ASM || defined(_REGSET_I386PSABI_NAMES) */
