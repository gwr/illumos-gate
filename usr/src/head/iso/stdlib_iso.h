 ...
 * the integer and floating point abs() inlines.  If math.h was
 * already included, the #define prevents redefinition errors.
 */
#if defined(__EXTENSIONS__) && !defined(_CXX_ABS_FLOAT_DEFINED)
...
#endif /* __EXTENSIONS__ && !_CXX_ABS_FLOAT_DEFINED */
} /* extern C++ */
#endif /* __cplusplus */
