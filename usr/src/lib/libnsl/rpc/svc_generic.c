...
/* LINTED pointer alignment */
	...
	case T_UNBND:
		 ...
		 *
		 * If we used a specified bind address, do this only
		 * after we bind both tcp6/ucp6 and tcp/udp.  That's
		 * sufficient, and allows the 2nd bind to succeed.
		 * Otherwise do this on every IP binding.
		 */
